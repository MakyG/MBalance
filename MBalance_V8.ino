// V1 - just bluetooth com
#include <TimedAction.h>

// V2 - including PID + Control
#include <Wire.h>
...
//#define KP_THROTTLE 0.160 less stable
//#define KI_THROTTLE 0.2   takes long to stop on position
#define KP_POSITION 0.06  
#define KD_POSITION 0.45  

/*
// slower rocking
#define KP_THROTTLE 0.09
#define KI_THROTTLE 0.12
//#define KP_THROTTLE 0.160 less stable
//#define KI_THROTTLE 0.2   takes long to stop on position 
#define KP_POSITION 0.08    
#define KD_POSITION 0.45 
*/
...
void loop() {
  ...
  if(Serial.available()) {
    ...
    if(v[1]==1) {
      ...
      Ok1=0;
      val1=v[2]; // STEER
      steerValue = ((float)val1 - 100)/100;

      Serial.println(steerValue);
      val2=v[3]; // THROTTLE
      throttleValue = ((float)val2 - 100);
    }
  }
